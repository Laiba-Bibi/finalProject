    ...
    <div className="w-full">
      ...
      <nav className="bg-white py-4 shadow-md relative">
        <div className="flex justify-between items-center px-4 sm:px-6 md:px-8">
          ...
          {/* Desktop Menu */}
          <div className="hidden md:flex space-x-8 text-[#4F9CF9]">
        ...
        {isOpen && (
          <div className="md:hidden bg-white px-4 pb-4 space-y-4 shadow-lg">
            <Link to="/" onClick={toggleMenu} className="block text-[#4F9CF9] hover:text-black">Home</Link>
            <Link to="/#about" onClick={toggleMenu} className="block text-[#4F9CF9] hover:text-black">About</Link>
            <Link to="/#contact" onClick={toggleMenu} className="block text-[#4F9CF9] hover:text-black">Contact</Link>
